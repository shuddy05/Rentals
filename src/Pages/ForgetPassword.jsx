...
const ForgetPassword = () => {
  ...
  return    <main className=" bg-[#f5f5e8] h-screen  ">
      <div className=" layout  flex flex-col md:flex-row justify-between items-center ">
        <div className=" w-full md:max-w-113.25 md:max-h-149.5 ">
          ...
          <p className="text-[16px] text-[#666666] mb-6"> We’ll send a 6-digit verification code to your email to reset your password.   </p>
...
<Link to="/" >
          ...
          <p className="text-gray-600  cursor-pointer text-center mt-[24px]">Remember your password <span className="text-[#7065F0]" >Sign In</span></p>
</Link>
