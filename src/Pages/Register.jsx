    ...
    <main className=" bg-[#f5f5e8] h-screen  ">
         <div className=" layout  flex flex-col md:flex-row justify-between items-center ">
           <div className=" w-full md:max-w-113.25 md:max-h-149.5 ">
             ...
             <p className="text-[16px] text-gray-500 mb-6">Enter your details to sign up</p>
        ...
        <Link to="/" >
             ...
             <p className="text-gray-600  cursor-pointer text-center mt-[24px]">Don't have account? <span className="text-[#7065F0]" >Login</span></p>
        </Link>
           </div>
